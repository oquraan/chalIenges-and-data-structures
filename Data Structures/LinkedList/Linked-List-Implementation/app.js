...
console.log("l.insertAt(0, 0 )" +"it is work becuse the list is empty and i store in the first node ")
l.insertAt(0, 0);
console.log("l.add(1);" +"it is work and insert the secound node in end of linkedlist ")

l.add(1);
console.log("l.add(2);" +"it is work and insert the thired node in end of linkedlist ")
